...
main()
{
  ...
  const Image vs = vertical_stripe(100, Colors::Caribbean_blue, Colors::red);
  ...
  create_BMP("rotate.bmp",
             ...
             height,
             rotate(vs, M_PI / 4.));
  create_BMP("vertical_stripe2.bmp",
             width,
             height,
             vs);
  ...
  create_BMP("circle.bmp",
             width,
             height,
             circle(Point(50., 100.), 10., Colors::Caribbean_blue, Colors::red));
